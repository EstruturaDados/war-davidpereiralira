...
// --- Constantes Globais --- Definem valores fixos para o número de territórios, missões e tamanho máximo de strings, facilitando a manutenção.
...
int main() {
    ...
    for (int i = 0; i < MAX_TERRITORIOS; i++) {
        ...
        fgets(territorios[i].nome, TAM_STRINGS, stdin);

        printf("Cor do Exercito:\n");
        fgets(territorios[i].cor, TAM_STRINGS, stdin);
